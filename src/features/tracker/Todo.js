	...
	return (
		<li className="border flex justify-between p-2 items-center">
			...
			<button
				...
				className={`inline-flex items-center flex-1 bg-white hover:bg-gray-100 text-gray-800 font-bold py-2 px-4 border border-gray-400 rounded shadow flex-grow-0 ${
